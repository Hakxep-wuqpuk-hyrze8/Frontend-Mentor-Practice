...
const Navbar = () => {
  return (
    <>
      <div className='container w-10/12 mx-auto flex flex-row items-center justify-between pt-6 pb-10'>
        {/* left section */}
        <div className='flex flex-row'>
          ...
          {navlinks.map(navlink => {
            ...
            return (
              <div className='w-fit inline-flex px-4 pt-1'>
                <div className='relative hover:before:content-[""] hover:before:absolute
                hover:before:left-[-10%] hover:before:bottom-[-3.25rem] hover:before:z-50  hover:before:block hover:before:h-1 hover:before:w-[120%] hover:before:bg-primary hover:before:rounded-lg'>
